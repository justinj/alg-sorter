...
{{
var G__19715 = cljs.core.deref.call(null,component__$1.parent);
var G__19716 = (level + 1);
component__$1 = G__19715;
level = G__19716;
continue;
}
} else
...
specljs.report.documentation.DocumentationReporter.cljs$lang$ctorPrWriter = (function (this__3378__auto__,writer__3379__auto__,opt__3380__auto__){return cljs.core._write.call(null,writer__3379__auto__,"specljs.report.documentation/DocumentationReporter");
});
...
var level = specljs.report.documentation.level_of.call(null,description);if((level === 0))
...
var characteristic = result.characteristic;var level = specljs.report.documentation.level_of.call(null,characteristic);cljs.core.println.call(null,specljs.reporting.green.call(null,specljs.reporting.indent.call(null,(level - 1),"- ",characteristic.name)));
return cljs.core.flush.call(null);
});
...
var characteristic = result.characteristic;var level = specljs.report.documentation.level_of.call(null,characteristic);cljs.core.println.call(null,specljs.reporting.red.call(null,specljs.reporting.indent.call(null,(level - 1),"- ",characteristic.name," (FAILED)")));
return cljs.core.flush.call(null);
});
