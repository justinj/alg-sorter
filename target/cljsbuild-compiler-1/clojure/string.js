...
{var pred__19645 = cljs.core._EQ_;var expr__19646 = limit;if(pred__19645.call(null,1,expr__19646))
{return cljs.core.vector.call(null,s);
} else
{if(pred__19645.call(null,2,expr__19646))
{return cljs.core.vector.call(null,"",s);
} else
...
{var ch = s.charAt(index);var temp__4090__auto___19652 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___19652))
{var replacement_19653 = temp__4090__auto___19652;buffer.append([cljs.core.str(replacement_19653)].join(''));
} else
{buffer.append(ch);
}
{
