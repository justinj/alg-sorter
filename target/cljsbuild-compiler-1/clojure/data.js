...
{return cljs.core.reduce.call(null,(function (result,p__20175){var vec__20176 = p__20175;var k = cljs.core.nth.call(null,vec__20176,0,null);var v = cljs.core.nth.call(null,vec__20176,1,null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__20178 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__20178,0,null);var b_STAR_ = cljs.core.nth.call(null,vec__20178,1,null);var ab = cljs.core.nth.call(null,vec__20178,2,null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (function (){var and__3941__auto__ = in_a;if(and__3941__auto__)
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__20179 = x;if(G__20179)
{if((function (){var or__3943__auto__ = (G__20179.cljs$lang$protocol_mask$partition0$ & 1024);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__20179.cljs$core$IMap$;
}
})())
{return true;
} else
{if((!G__20179.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IMap,G__20179);
} else
{return false;
}
}
...
{if((function (){var G__20180 = x;if(G__20180)
{if((function (){var or__3943__auto__ = (G__20180.cljs$lang$protocol_mask$partition0$ & 4096);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__20180.cljs$core$ISet$;
}
})())
{return true;
} else
{if((!G__20180.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.ISet,G__20180);
} else
{return false;
}
}
...
{if((function (){var G__20181 = x;if(G__20181)
{if((function (){var or__3943__auto__ = (G__20181.cljs$lang$protocol_mask$partition0$ & 16777216);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__20181.cljs$core$ISequential$;
}
})())
{return true;
} else
{if((!G__20181.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.ISequential,G__20181);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__20182 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__20182))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__20182))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__20182))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__20182))
