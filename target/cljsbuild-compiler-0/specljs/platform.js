...
specljs.platform.SpecFailure.cljs$lang$ctorPrWriter = (function (this__3381__auto__,writer__3382__auto__,opts__3383__auto__){return cljs.core._write.call(null,writer__3382__auto__,"specljs.platform/SpecFailure");
});
...
specljs.platform.SpecPending.cljs$lang$ctorPrWriter = (function (this__3381__auto__,writer__3382__auto__,opts__3383__auto__){return cljs.core._write.call(null,writer__3382__auto__,"specljs.platform/SpecPending");
});
...
specljs.platform.pending_QMARK_ = (function pending_QMARK_(e){return cljs.core.isa_QMARK_.call(null,cljs.core.type.call(null,e),specljs.platform.pending);
});
specljs.platform.failure_QMARK_ = (function failure_QMARK_(e){return cljs.core.isa_QMARK_.call(null,cljs.core.type.call(null,e),specljs.platform.failure);
});
...
{return [cljs.core.str(e.fileName),cljs.core.str(":"),cljs.core.str((function (){var or__3943__auto__ = e.lineNumber;if(cljs.core.truth_(or__3943__auto__))
...
specljs.platform.stack_trace = (function stack_trace(e){return cljs.core.rest.call(null,clojure.string.split_lines.call(null,(function (){var or__3943__auto__ = e.stack;if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return e.toString();
}
...
specljs.platform.print_stack_trace = (function print_stack_trace(e){return cljs.core.println.call(null,(function (){var or__3943__auto__ = e.stack;if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
