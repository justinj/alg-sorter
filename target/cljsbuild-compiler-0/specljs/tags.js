...
{return cljs.core.not.call(null,cljs.core.some.call(null,(function (p1__18258_SHARP_){return cljs.core.contains_QMARK_.call(null,excludes,p1__18258_SHARP_);
}),tags));
}
});
...
var pass_tag_filter_QMARK___2 = (function (filter,tags){var and__3941__auto__ = specljs.tags.pass_includes_QMARK_.call(null,new cljs.core.Keyword(null,"includes","includes",1104163901).call(null,filter),tags);if(cljs.core.truth_(and__3941__auto__))
...
specljs.tags.tag_sets_for = (function tag_sets_for(context){var context_seq = cljs.core.tree_seq.call(null,(function (p1__18259_SHARP_){return !((p1__18259_SHARP_ == null));
}),(function (p1__18260_SHARP_){return cljs.core.deref.call(null,p1__18260_SHARP_.children);
}),context);return cljs.core.map.call(null,specljs.tags.tags_for,context_seq);
});
specljs.tags.context_with_tags_seq = (function context_with_tags_seq(context){var context_seq = cljs.core.tree_seq.call(null,(function (p1__18261_SHARP_){return !((p1__18261_SHARP_ == null));
}),(function (p1__18262_SHARP_){return cljs.core.deref.call(null,p1__18262_SHARP_.children);
}),context);return cljs.core.map.call(null,(function (p1__18263_SHARP_){return cljs.core.hash_map.call(null,new cljs.core.Keyword(null,"context","context",1965435169),p1__18263_SHARP_,new cljs.core.Keyword(null,"tag-set","tag-set",3758720801),specljs.tags.tags_for.call(null,p1__18263_SHARP_));
}),context_seq);
});
...
var describe_filter__1 = (function (filter){var includes = cljs.core.seq.call(null,cljs.core.map.call(null,cljs.core.name,new cljs.core.Keyword(null,"includes","includes",1104163901).call(null,filter)));var excludes = cljs.core.seq.call(null,cljs.core.map.call(null,cljs.core.name,new cljs.core.Keyword(null,"excludes","excludes",3007959371).call(null,filter)));if((function (){var or__3943__auto__ = includes;if(or__3943__auto__)
