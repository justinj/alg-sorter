...
}catch (e18691){if((e18691 instanceof Error))
{var e = e18691;throw (new Error([cljs.core.str("Failed to load runner: "),cljs.core.str(name)].join(''),e));
} else
...
}catch (e18693){if((e18693 instanceof Error))
{var e = e18693;throw (new Error([cljs.core.str("Failed to load reporter: "),cljs.core.str(name)].join(''),e));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e18693;
} else
...
*/
specljs.config.with_config = (function with_config(config,action){var _STAR_runner_STAR_18705 = specljs.config._STAR_runner_STAR_;var _STAR_reporters_STAR_18706 = specljs.config._STAR_reporters_STAR_;var _STAR_specs_STAR_18707 = specljs.config._STAR_specs_STAR_;var _STAR_color_QMARK__STAR_18708 = specljs.config._STAR_color_QMARK__STAR_;var _STAR_full_stack_trace_QMARK__STAR_18709 = specljs.config._STAR_full_stack_trace_QMARK__STAR_;var _STAR_tag_filter_STAR_18710 = specljs.config._STAR_tag_filter_STAR_;try{specljs.config._STAR_runner_STAR_ = (cljs.core.truth_(new cljs.core.Keyword(null,"runner","runner",4389065378).call(null,config))?(function (){cljs.core.println.call(null,"loading runner in config");
...
}finally {specljs.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR_18710;
