...
clojure.set.bubble_max_key = (function bubble_max_key(k,coll){var max = cljs.core.apply.call(null,cljs.core.max_key,k,coll);return cljs.core.cons.call(null,max,cljs.core.remove.call(null,(function (p1__18264_SHARP_){return (max === p1__18264_SHARP_);
}),coll));
});
/**
...
var G__18265__delegate = function (s1,s2,sets){var bubbled_sets = clojure.set.bubble_max_key.call(null,cljs.core.count,cljs.core.conj.call(null,sets,s2,s1));return cljs.core.reduce.call(null,cljs.core.into,cljs.core.first.call(null,bubbled_sets),cljs.core.rest.call(null,bubbled_sets));
};
...
var G__18270__delegate = function (s1,s2,sets){var bubbled_sets = clojure.set.bubble_max_key.call(null,(function (p1__18267_SHARP_){return (- cljs.core.count.call(null,p1__18267_SHARP_));
...
var G__18272__delegate = function (s1,s2,sets){return cljs.core.reduce.call(null,difference,s1,cljs.core.conj.call(null,sets,s2));
};
...
*/
clojure.set.project = (function project(xrel,ks){return cljs.core.set.call(null,cljs.core.map.call(null,(function (p1__18274_SHARP_){return cljs.core.select_keys.call(null,p1__18274_SHARP_,ks);
}),xrel));
});
/**
* Returns the map with the keys in kmap renamed to the vals in kmap
*/
clojure.set.rename_keys = (function rename_keys(map,kmap){return cljs.core.reduce.call(null,(function (m,p__18277){var vec__18278 = p__18277;var old = cljs.core.nth.call(null,vec__18278,0,null);var new$ = cljs.core.nth.call(null,vec__18278,1,null);if((function (){var and__3941__auto__ = cljs.core.not_EQ_.call(null,old,new$);if(and__3941__auto__)
...
*/
clojure.set.rename = (function rename(xrel,kmap){return cljs.core.set.call(null,cljs.core.map.call(null,(function (p1__18279_SHARP_){return clojure.set.rename_keys.call(null,p1__18279_SHARP_,kmap);
}),xrel));
});
/**
...
*/
clojure.set.map_invert = (function map_invert(m){return cljs.core.reduce.call(null,(function (m__$1,p__18282){var vec__18283 = p__18282;var k = cljs.core.nth.call(null,vec__18283,0,null);var v = cljs.core.nth.call(null,vec__18283,1,null);return cljs.core.assoc.call(null,m__$1,v,k);
...
{var ks = clojure.set.intersection.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,cljs.core.first.call(null,xrel))),cljs.core.set.call(null,cljs.core.keys.call(null,cljs.core.first.call(null,yrel))));var vec__18290 = (((cljs.core.count.call(null,xrel) <= cljs.core.count.call(null,yrel)))?cljs.core.PersistentVector.fromArray([xrel,yrel], true):cljs.core.PersistentVector.fromArray([yrel,xrel], true));var r = cljs.core.nth.call(null,vec__18290,0,null);var s = cljs.core.nth.call(null,vec__18290,1,null);var idx = clojure.set.index.call(null,r,ks);return cljs.core.reduce.call(null,(function (ret,x){var found = idx.call(null,cljs.core.select_keys.call(null,x,ks));if(cljs.core.truth_(found))
{return cljs.core.reduce.call(null,(function (p1__18284_SHARP_,p2__18285_SHARP_){return cljs.core.conj.call(null,p1__18284_SHARP_,cljs.core.merge.call(null,p2__18285_SHARP_,x));
}),ret,found);
} else
{return ret;
}
...
var join__3 = (function (xrel,yrel,km){var vec__18291 = (((cljs.core.count.call(null,xrel) <= cljs.core.count.call(null,yrel)))?cljs.core.PersistentVector.fromArray([xrel,yrel,clojure.set.map_invert.call(null,km)], true):cljs.core.PersistentVector.fromArray([yrel,xrel,km], true));var r = cljs.core.nth.call(null,vec__18291,0,null);var s = cljs.core.nth.call(null,vec__18291,1,null);var k = cljs.core.nth.call(null,vec__18291,2,null);var idx = clojure.set.index.call(null,r,cljs.core.vals.call(null,k));return cljs.core.reduce.call(null,(function (ret,x){var found = idx.call(null,clojure.set.rename_keys.call(null,cljs.core.select_keys.call(null,x,cljs.core.keys.call(null,k)),k));if(cljs.core.truth_(found))
{return cljs.core.reduce.call(null,(function (p1__18286_SHARP_,p2__18287_SHARP_){return cljs.core.conj.call(null,p1__18286_SHARP_,cljs.core.merge.call(null,p2__18287_SHARP_,x));
}),ret,found);
} else
{return ret;
}
...
{return cljs.core.every_QMARK_.call(null,(function (p1__18292_SHARP_){return cljs.core.contains_QMARK_.call(null,set2,p1__18292_SHARP_);
}),set1);
} else
{return and__3941__auto__;
}
...
{return cljs.core.every_QMARK_.call(null,(function (p1__18293_SHARP_){return cljs.core.contains_QMARK_.call(null,set1,p1__18293_SHARP_);
}),set2);
} else
{return and__3941__auto__;
}
